...
- [File organization problem](project_file_organization.md) — Files scattered across C/E/F drives causing Claude browser and Code instability; FAT32 on E breaks Linux permissions; needs reorganization before next build session

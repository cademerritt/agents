...
1. [feedback_wait_for_authorization.md](feedback_wait_for_authorization.md) — Never act without explicit authorization — no file writes, edits, or commands until Cade says yes to the specific action
2. [flashcard_system_progress.md](flashcard_system_progress.md) — Flashcard quiz system at /media/cade/E/wiki/flashcards/ — 54 questions, 8 topic files, 16 rules in instructions.md, designed to grow into AI/LLM topics
3. [flashcard_quiz_topic_mapping.md](flashcard_quiz_topic_mapping.md) — Maps each quiz question to its wrong_answers/ topic file; hooks.md covers Q26-Q54
4. [session-05-05-2026-1433.md](session-05-05-2026-1433.md) — Session May 5 2026 — browser agent built, hookify overhaul, CLAUDE.md cleanup, Ed Donner Udemy course recommended
5. [session-05-06-2026-2002.md](session-05-06-2026-2002.md) — Session May 6 2026 — break alert/blackout system built, PostToolUse rewritten to track any file, hookify concepts learned
